...
from mock_data.toomredf.toomredf import ToomrePotential
...
def Energy(coord):
    ...
    potential = evaluatePotentials(pot, R, z)
...
def del_E(coord):
    ...
    F_phi = evaluatephiforces(pot, R, z, phi)
    F_R = evaluateRforces(pot, R, z, phi)
    F_z= evaluatezforces(pot, R, z, phi)
