...
location = sample_location_interpolate_selection(df=qdf.density,n=1700000,
                                                 R_min=0.9375, R_max=1.0625,
                                                 z_min=-0.0625, z_max=0.0625,
                                                 phi_min=-0.0624,
                                                 phi_max=0.0624,
                                                 df_max = qdf_max,
                                                 pixel_R = 0.01,
...
#save data
np.save("qdf sample cartesian physical with selection, date={}.npy".format(str(date)), physical_rect)
